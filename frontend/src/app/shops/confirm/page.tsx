  ...
  useEffect(() => {
    ...
    try {
      ...
      if (storedData) {
        ...
        console.log('[新規登録確認画面] sessionStorageから読み込んだデータのservices確認:', {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const submitData: ShopCreateRequest = {
        ...
        smokingType: (shopData.smokingType as "non_smoking" | "separated" | "smoking_allowed" | "electronic_only" | undefined) || undefined,
      ...
      } as ShopCreateRequest;

      // submitDataのservices確認ログ
      console.log('[新規登録確認画面] submitDataのservices確認:', {
